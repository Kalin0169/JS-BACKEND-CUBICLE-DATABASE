...
I use both **The System Errors** and my own **Custom Errors** in my App. **The Errors** comming from the **DataBase**, respectivly from the **Mongoose Schema**, are parsed separately. **All Errors** are to be catched at the **Global Error Handler**, as well as using the other **Approach** to **show them at the Corresponding Controller**. 
